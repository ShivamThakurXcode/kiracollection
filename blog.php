...
include 'components/modal-overlay.php';
include 'components/scroll-to-top.php';
include 'components/sidebar.php';
include 'components/cart-sidebar.php';
include 'components/register-sidebar.php';
include 'components/login-sidebar.php';
include 'components/forgot-password-sidebar.php';
include 'components/otp-verification-sidebar.php';
...
<?php
include 'components/subscribe-section.php';
include 'components/footer.php';
include 'components/footer-bottom-nav.php';
include 'components/js-scripts.php';
?>
          ...
          <nav class="mobile-menu">
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href='/product-details'>Product Details Version 1</a
                        >
                      </li>
                      <li>
                        <a href='/product-details-2'>Product Details Version 2</a
                        >
                      </li>
                      <li>
                        <a href='/product-details-3'>Product Details Version 3</a
                        >
                      </li>
                      <li>
                        <a href='/product-details-4'>Product Details Version 4</a
                        >
                      </li>
                      <li>
                        <a href='/product-details-5'>Product Details Version 5</a
                        >
                      </li>
                      <li>
                        <a href='/product-details-6'>Product Details Version 6</a
                        >
                      </li>
                    </ul>
                  </li>
                  <li>
                    <a href='/wishlist-style-v1'>Shop - Wishlist Version 1</a
                    >
                  </li>
                  <li>
                    <a href='/wishlist-style-v2'>Shop - Wishlist Version 2</a
                    >
                  </li>
                  <li><a href='/cart-single-vendor'>Shop - Cart</a></li>
                  <li>
                    <a href='/cart-multi-vendor'>Shop - Cart Multi Vendor</a
                    >
                  </li>
              ...
              <li>
                <a href="#">Sellers</a>
                <ul>
                  <li><a href='/vendors-grid'>Seller Grid</a></li>
                  <li><a href='/vendors-list'>Seller List</a></li>
                  <li>
                    <a href='/vendor-left-sidebar-marketplace'>
                      Seller Market Place v1
                    </a>
                  </li>
                  <li>
                    <a href='/vendor-left-top-marketplace'>
                      Seller Market Place v2
                    </a>
                  </li>
                  <li><a href='/vendor-account'>Seller Account</a></li>
                  <li>
                    <a href='/vendor-dashboard'>Seller Dashboard</a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href='/shop-left-sidebar-3col'>3 Columns (Left Filter)</a
                        >
                      </li>
                      <li>
                        <a href='/shop-left-sidebar-4col'>4 Columns (Left Filter)</a
                        >
                      </li>
                      <li>
                        <a href='/shop-left-sidebar-5col'>5 Columns (Left Filter)</a
                        >
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href='/banner-left-sidebar-3col'>3 Columns (Left Filter)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-left-sidebar-4col'>3 Columns (Left Filter)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-left-sidebar-5col'>3 Columns (Left Filter)</a
                        >
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href='/full-banner-3col'>Grid - 3 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/full-banner-4col'>Grid - 4 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/full-banner-5col'>Grid - 5 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/full-banner-6col'>Grid - 6 Columns (Banner)</a
                        >
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href='/banner-with-horizontal-filter-3col'>Grid - 3 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-with-horizontal-filter-4col'>Grid - 4 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-with-horizontal-filter-5col'>Grid - 5 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-with-horizontal-filter-6col'>Grid - 6 Columns (Banner)</a
                        >
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <a href='/banner-list-with-sidebar'>List - 1 Column (Left Filter)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-list-without-sidebar-2col'>List - 2 Columns (Left Filter)</a
                        >
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href='/banner-category-filter-3col'>Grid - 3 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-category-filter-4col'>Grid - 4 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-category-filter-5col'>Grid - 5 Columns (Banner)</a
                        >
                      </li>
                      <li>
                        <a href='/banner-category-filter-6col'>Grid - 6 Columns (Banner)</a
                        >
                      </li>
                    </ul>
                  </li>
              ...
              <li>
                ...
                <ul>
                  <li><a class='active' href='/404'>404 Page</a></li>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <a class='similar-product-item-image w-[102px] h-[102px] rounded-xl bg-[#F4F3F5] overflow-hidden relative' href='/product-details'>
              <img
              ...
              />
              <span
                class="product-discount-badge absolute top-[11px] left-0 bg-error text-warning-lighter font-medium text-sm leading-[22px] px-1 after:absolute after:top-0 after:left-full after:z-10 after:w-1 after:h-full after:bg-[url('../images/discount-shape.png')] after:bg-contain"
                >Sale</span
              >
            </a>
            <div
            ...
            >
              <h6 class="text-base font-semibold">
                <a href='/product-details'>Fresh Bask Basket Fruits</a>
              </h6>
              ...
              <div class="flex items-center justify-between">
                ...
                <a class='btn btn-primary btn-medium rounded-full font-semibold text-sm leading-6 px-4 py-2' href='/cart-single-vendor'>
                  <span>
                    <i
      ...
      >
        ...
        >
          ...
          >
            <a class='cart-product-item-image sm:w-[102px] sm:h-[102px] rounded-xl bg-[#F4F3F5] overflow-hidden relative' href='/product-details'>
              <img
          ...
          >
            <a class='cart-product-item-image sm:w-[102px] sm:h-[102px] rounded-xl bg-[#F4F3F5] overflow-hidden relative' href='/product-details'>
              ...
              />
              <span
                class="product-discount-badge absolute top-1/2 -translate-y-1/2 left-0 bg-error text-warning-lighter font-medium text-sm leading-[22px] px-1 after:absolute after:top-0 after:left-full after:z-10 after:w-1 after:h-full after:bg-[url('../images/discount-shape.png')] after:bg-contain"
                >Out of Stock</span
              >
            </a>
            <div
        ...
        >
          ...
          <div class="cart-buttons flex items-center gap-x-4">
            <a class='btn btn-default outline btn-large rounded-[80px] flex-1 shadow-none' href='/cart-single-vendor'>
              View Cart
            </a>
          ...
          <div class="flex items-center xl:justify-between justify-center">
            ...
            <div class="hidden xl:flex">
              <ul class="flex items-center text-white">
                <li>
                  <a class='text-sm leading-[22px] text-white pr-[19px] mr-[19px] py-3.5 relative after:absolute after:h-7.5 after:w-px after:bg-primary-light after:right-0 after:top-1/2 after:-translate-y-1/2' href='/about'>About us</a
                  >
                </li>
                <li>
                  <a
            ...
            <nav class="main-menu">
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <a href='/wishlist-style-v1'>
                            Shop - Wishlist
                          </a>
                        </li>
                        <li>
                          <a href='/wishlist-style-v2'>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <a href='/cart-single-vendor'> Shop - Cart </a>
                        </li>
                        <li>
                          <a href='/cart-multi-vendor'>
                    ...
                    <li>
                      <a href='/order-successful'>Shop - Order Success</a>
                    </li>
                    <li>
                      <a href='/compare'>Shop - Compare</a>
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      <a href='/vendors-grid'> Seller Grid </a>
                    </li>
                    <li>
                      <a href='/vendors-list'> Seller List </a>
                    </li>
                    <li>
                      <a href='/vendor-left-sidebar-marketplace'>
                        Seller Market Place v1
                    ...
                    <li>
                      <a href='/vendor-account'> Seller Account </a>
                      <a href='/vendor-dashboard'> Seller Dashboard </a>
                    </li>
                  </ul>
                </li>
                      ...
                      >
                        ...
                        <div class="flex flex-col gap-y-1.5 pr-4">
                          ...
                          <ul class="flex flex-col gap-y-2">
                            ...
                            <li>
                              <a href='/banner-left-sidebar-4col'>4 Columns (Left Filter)</a
                              >
                            </li>
                            <li>
                              <a href='/banner-left-sidebar-5col'>5 Columns (Left Filter)</a
                              >
                            </li>
                          </ul>
                        </div>
                        ...
                        <div class="flex flex-col gap-y-1.5 pr-4">
                          ...
                          <ul class="flex flex-col gap-y-2">
                            <li>
                              <a href='/top-banner-left-sidebar-3col'>Grid - 3 Columns (Left Filter)</a
                              >
                            </li>
                            <li>
                              <a href='/top-banner-left-sidebar-4col'>Grid - 4 Columns (Left Filter)</a
                              >
                            </li>
                            <li>
                              <a href='/top-banner-left-sidebar-5col'>Grid - 5 Columns (Left Filter)</a
                              >
                            </li>
                            <li>
                              <a href='/banner-list-with-sidebar'>List - 1 Column (Left Filter)</a
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      <a class='active' href='/404'> 404 Page </a>
                    </li>
                    <li>
                      <a href='/coming-soon'> Coming Soon Page </a>
                    </li>
                    <li>
                      <a href='/faq'> FAQ </a>
                    </li>
    ...
    <div class="container py-12">
      <div class="breadcrumb">
        <ul>
          ...
          <li><span class="text-sm leading-[22px]">404</span></li>
        </ul>
      </div>
    </div>
    ...
    <div class="notfound">
      <div class="notfound-section">
        <img src="./assets/images/404.png" alt="404 Cart" />
        <h2
        ...
        <div
          class="btn btn-large btn-primary rounded-[100px] py-[11px] wow animate__animated animate__fadeInUp"
          data-wow-delay=".2s"
        >
    ...
    >
      <div class="container">
          ...
          >
            ...
            <ul class="flex flex-col gap-y-1.5 pt-4">
              <li class="py-1.5 flex items-center gap-x-2">
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='/about'>About Us</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
          ...
          >
            ...
            <ul class="flex flex-col gap-y-1.5 pt-4">
              <li class="py-1.5 flex items-center gap-x-2">
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='/my-account'>Your Account</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
              ...
              <li class="py-1.5 flex items-center gap-x-2">
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='/vendor-account'>Become a Vendor</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
                ...
                <a class='text-primary-lighter font-semibold hover:underline' href='/wishlist-style-v2'>Wishlist</a
                >
              </li>
              <li class="py-1.5 flex items-center gap-x-2">
                <span class="inline-flex items-center"
        ...
        <div
          class="text-center text-white bg-[url('../images/bottom-border.png')] pt-[22px] bg-center pb-px bg-no-repeat wow animate__animated animate__fadeInUp"
          data-wow-delay=".2s"
        >
    ...
    >
      <div class="container">
        <ul class="flex items-center justify-between footer-bottom-nav -mt-px">
          ...
          <li class="group">
            <a class='footer-bottom-nav-btn flex items-center flex-col gap-y-1 border-t-2 border-transparent text-sm leading-[22px] text-light-primary-text px-[9px] pt-2.5 pb-1' href='/cart-single-vendor'><span class="inline-flex items-center justify-center">
                <i
          ...
          <li class="group">
            <a class='footer-bottom-nav-btn flex items-center flex-col gap-y-1 border-t-2 border-transparent text-sm leading-[22px] text-light-primary-text px-[9px] pt-2.5 pb-1' href='/wishlist-style-v1'><span class="inline-flex items-center justify-center">
                <i

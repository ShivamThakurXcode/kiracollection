...
<body>
    ...
    $breadcrumbBg = 'assets/images/about/woman-on-phone.jpg';
            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12">
                    ...
                    <div class="mb-10 wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                        <div class="h-[320px] md:h-[420px] overflow-hidden rounded-2xl">
                            <img src="<?= $current_blog['image'] ?>"
                                alt="<?= htmlspecialchars($current_blog['title']) ?>"
                                class="rounded-2xl w-full h-full object-cover" />
                        </div>
                        <div
                            class="border border-gray-300 rounded-2xl bg-white p-6 md:p-8 -mt-10 md:-mt-14 relative z-10">
                            <div class="mb-4">
                    ...
                    <!-- Author Section -->
                    <!-- <div class="border border-gray-300 rounded-2xl p-6 mb-8 wow animate__animated animate__fadeInUp"
                        data-wow-delay="0.5s">
                        <div class="flex items-start gap-4">
                            <div class="w-16 h-16 rounded-full overflow-hidden flex-shrink-0">
                                <img src="<?= $current_blog['author_image'] ?>"
                                    alt="<?= htmlspecialchars($current_blog['author']) ?>"
                                    class="w-full h-full object-cover" />
                            </div>
                            <div class="flex-grow">
                                <h4 class="text-lg font-semibold text-light-primary-text mb-2">
                                    <?= htmlspecialchars($current_blog['author']) ?>
                                </h4>
                                <p class="text-light-secondary-text text-sm leading-[22px] mb-3">
                                    Passionate about traditional Indian arts and crafts. Sharing knowledge about Lippan
                                    art, Mandala designs, and home decor to help you create beautiful spaces.
                                </p>
                                <div class="flex items-center gap-3">
                                    <a href="#" class="text-primary hover:underline text-sm">View All Posts</a>
                                </div>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <!-- <div class="mb-8 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="#"
                                ...
                                <i class="hgi hgi-stroke hgi-whatsapp-01 text-xl"></i>
                            </a>
                        </div>
                    </div> -->

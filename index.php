...
<head>
  ...
  <?php include 'components/preloader.php' ?>
    ...
    <section class="mb-[70px]">
      <div
        class="bg-[#FFD6EF] xl:max-w-[1728px] w-full mx-auto xl:rounded-tr-5xl relative flex flex-col gap-y-4 md:gap-y-0 md:flex-row items-center justify-between pt-12 lg:pt-0"
      >
        <div
          class="lg:bg-white bg-[#FFD6EF] pb-0 lg:pt-0 flex-none lg:w-full lg:pb-[23px] lg:pl-12 pl-4 md:text-left text-center max-w-xl lg:rounded-tr-[164px] relative z-5 lg:after:bg-[#FFD6EF] lg:before:absolute lg:before:top-full lg:before:left-0 lg:before:h-12 lg:before:w-12 lg:before:bg-[url('images/home-2/slider-left-shape-2.html')] lg:before:bg-no-repeat lg:before:z-11 lg:after:absolute lg:after:bottom-0 lg:after:right-0 lg:after:h-full lg:after:w-[145px] lg:after:bg-[url('images/slider-right-shape.html')] lg:after:bg-no-repeat lg:after:z-11"
        >
          <h3
            data-wow-delay=".2s"
            class="wow animate__animated animate__fadeInUp mb-2"
          >
            Today's Top Offer
          </h3>
          <p
        ...
        <div
          data-wow-delay=".2s"
          class="wow animate__animated animate__fadeInUp flex z-5 items-center gap-x-5 lg:pr-12 pr-4"
        >
          <div
      ...
      <div
        class="xl:max-w-[1728px] w-full mx-auto relative bg-[#FFD6EF] xl:rounded-bl-5xl xl:rounded-br-5xl py-12"
      >
        <div class="container">
    ...
    <section class="pb-[70px]">
      <div class="container">
        <div class="grid grid-cols-12 gap-6">
          ...
          >
            <div
              class="flex flex-col justify-end p-4 lg:p-8 h-[550px] rounded-2xl bg-[url('assets/images/home-2/apply-facewash.jpg')] bg-center bg-no-repeat"
            >
              <div class="p-4 bg-[#9EE872] rounded-2xl">
                <div>
                  <span
                ...
                <h3 class="py-1.5">Your Daily Store.</h3>
                <p class="pb-4 text-light-primary-text">
                  Essentials, deals, and more.
                </p>
                <a class='btn btn-primary text-white font-semibold btn-large rounded-[60px] text-sm leading-6 group py-1.5 pl-4 pr-2' href='shop-left-sidebar-3col.html'>
                  Shop Now
                  <span
                    class="size-8 ml-0.5 bg-white inline-flex items-center justify-center rounded-full rotate-[-40deg] transform group-hover:rotate-0 transition-all duration-300"
                  >
                    <i
                      class="hgi hgi-stroke hgi-arrow-right-02 text-xl text-primary-darker"
                    ></i>
          ...
          >
            <div
              class="flex flex-col justify-end p-4 lg:p-8 h-[550px] rounded-2xl bg-[url(../images/home-2/apply-makeup-1.jpg)] bg-center bg-no-repeat"
            >
              <div class="p-4 bg-[#FFD6EF] rounded-2xl">
                <div>
                  <span
                    class="text-light-primary-text bg-warning-light px-3 py-1 rounded-full text-base font-semibold"
                  >
                ...
                <h3 class="py-1.5">Everyday Made Simple.</h3>
                <p class="pb-4 text-light-primary-text">
          ...
          >
            <div
              class="flex flex-col justify-end p-4 lg:p-8 h-[550px] rounded-2xl bg-[url(../images/home-2/apply-makeup-2.jpg)] bg-center bg-no-repeat"
            >
              <div class="p-4 bg-[#A0E2E0] rounded-2xl">
                <div>
                  <span
                    class="text-light-primary-text bg-warning-light px-3 py-1 rounded-full text-base font-semibold"
                  >
                ...
                <h3 class="py-1.5">Your Cart. Your Way.</h3>
                <p class="pb-4 text-light-primary-text">
    ...
    <section class="pb-[70px]">
      <div class="container">
        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-6">
          <div
            class="mx-auto wow animate__animated animate__fadeInUp"
            data-wow-delay=".2s"
          >
            <img src="assets/images/home-2/spa-logo.png" alt="Spa & Salon" />
          </div>
          <div
            class="mx-auto wow animate__animated animate__fadeInUp"
            data-wow-delay=".3s"
          >
            <img
              src="assets/images/home-2/cosmetic-logo.png"
          ...
          >
            <img
              src="assets/images/home-2/beauty-logo.png"
              alt="Beauty Spa"
            />
          </div>
          <div
          ...
          >
            <img
              src="assets/images/home-2/salon-logo.png"
              alt="Beauty Salon"
            />
          </div>
          <div
          ...
          >
            <img
              src="assets/images/home-2/boutique-logo.png"
              alt="Beauty Boutique"
            />
          </div>
          <div
          ...
          >
            <img
              src="assets/images/home-2/therapy-logo.png"
              alt="Nature Therapy"
            />
          </div>
        </div>
    ...
    <section class="mb-[70px]">
      <div
        class="bg-[#FFEB69] xl:max-w-[1728px] w-full mx-auto xl:rounded-tr-5xl relative flex flex-col gap-y-4 md:gap-y-0 md:flex-row items-center justify-between pt-12 lg:pt-0"
      >
        <div
        ...
        >
          <div
            class="home-two-newly-launched-product-nav md:flex items-center justify-center gap-x-6 hidden"
          ></div>
        </div>
      </div>

      <div
        class="xl:max-w-[1728px] w-full mx-auto relative bg-[#FFEB69] xl:rounded-bl-5xl xl:rounded-br-5xl py-12"
      >
        <div class="container">
          <div class="home-two-newly-launched-product-slider-wrapper">
            <div
              class="home-two-newly-launched-product-slider -mx-3 sellzy-slider"
              data-slick='{"slidesToShow": 5, "slidesToScroll": 1, "loop": true, "arrows": true, "infinite": true, "appendArrows": ".home-two-newly-launched-product-nav", "autoplay": true, "autoplaySpeed": 7000, "responsive": [{"breakpoint": 1441, "settings": {"slidesToShow": 4}}, {"breakpoint": 1025, "settings": {"slidesToShow": 3}}, {"breakpoint": 769, "settings": {"slidesToShow": 2}}, {"breakpoint": 480, "settings": {"slidesToShow": 1}}]}'
            >
              <!-- 1 -->
              <div
                class="bg-white rounded-2xl product-card-1 p-4 group mx-3 wow animate__animated animate__fadeInUp"
                data-wow-delay="0.2s"
              >
                <div class="product-image-container relative">
                  <div
                  ...
                  >
                    <a href='product-details.html'>
                      <img
                        src="assets/images/multi-vendor-slider-image-1.png"
                        alt="product-1"
                        class="group-hover:scale-110 transition-all transform group-hover:-rotate-3 ease-in-out duration-300"
                      />
                    </a>
                  ...
                  <span
                    class="product-discount-badge absolute top-[11px] left-0 bg-success-light text-black font-normal text-sm leading-[22px] px-1 after:absolute after:top-0 after:left-full after:z-10 after:w-1 after:h-full after:bg-[url('images/discount-primary-shape.html')] after:bg-contain"
                    >NEW</span
                  >
                  <div
                    class="product-btn-actions absolute bottom-0 right-0 left-0 flex justify-center z-9 transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100 group-hover:bottom-3"
                ...
                <div class="product-content">
                  ...
                  <div class="price-section flex items-center gap-x-3 mb-2">
                    <span
                      class="current-price text-xl leading-[30px] font-bold text-light-primary-text"
                      >$27.49</span
                    >
                    <span
                      class="old-price text-xl leading-[30px] font-medium text-light-disabled-text line-through"
                      >$39.99</span
                    >
                    <span
                      class="discount-percentage text-xl leading-[30px] font-medium text-error"
                      >10% OFF</span
                    >
                  </div>
                  <div class="btn-section flex items-center gap-x-4">
              ...
              >
                <div class="product-image-container relative">
                  ...
                  >
                    <a href='product-details.html'>
                      <img
                        src="assets/images/multi-vendor-slider-image-2.png"
                        alt="product-2"
                        class="group-hover:scale-110 transition-all transform group-hover:-rotate-3 ease-in-out duration-300"
                      />
                    </a>
              ...
              >
                <div class="product-image-container relative">
                  ...
                  >
                    <a href='product-details.html'>
                      <img
                        src="assets/images/multi-vendor-slider-image-3.png"
                        alt="product-3"
                        class="group-hover:scale-110 transition-all transform group-hover:-rotate-3 ease-in-out duration-300"
                      />
                    </a>
              ...
              >
                <div class="product-image-container relative">
                  ...
                  >
                    <a href='product-details.html'>
                      <img
                        src="assets/images/multi-vendor-slider-image-4.png"
                        alt="product-4"
                        class="group-hover:scale-110 transition-all transform group-hover:-rotate-3 ease-in-out duration-300"
                      />
                    </a>
              ...
              >
                <div class="product-image-container relative">
                  ...
                  >
                    <a href='product-details.html'>
                      <img
                        src="assets/images/multi-vendor-slider-image-5.png"
                        alt="product-5"
                        class="group-hover:scale-110 transition-all transform group-hover:-rotate-3 ease-in-out duration-300"
                      />
                    </a>
          ...
          <div
            class="flex md:justify-end justify-center wow animate__animated animate__fadeInUp"
            data-wow-delay="1.2s"
          >
            <a class='btn btn-primary bg-white text-primary-darker font-semibold btn-large rounded-[60px] text-sm leading-6 group py-1.5 pl-3 pr-2 mt-12' href='shop-left-sidebar-3col.html'>
              View All Products
              <span
    ...
    <section class="mb-[70px]">
      <div
        class="bg-[#92BDF5] xl:max-w-[1728px] w-full mx-auto xl:rounded-tr-5xl relative flex flex-col gap-y-4 md:gap-y-0 md:flex-row items-center justify-between pt-12 lg:pt-0"
      >
        <div
          class="lg:bg-white bg-[#92BDF5] pb-0 lg:pt-0 flex-none lg:w-full lg:pb-[23px] lg:pl-12 pl-4 md:text-left text-center max-w-xl lg:rounded-tr-[164px] relative z-5 lg:after:bg-[#92BDF5] lg:before:absolute lg:before:top-full lg:before:left-0 lg:before:h-12 lg:before:w-12 lg:before:bg-[url('images/home-2/slider-left-shape-2.html')] lg:before:bg-no-repeat lg:before:z-11 lg:after:absolute lg:after:bottom-0 lg:after:right-0 lg:after:h-full lg:after:w-[145px] lg:after:bg-[url('images/slider-right-shape.html')] lg:after:bg-no-repeat lg:after:z-11"
        >
          <h3
            data-wow-delay=".2s"
            class="wow animate__animated animate__fadeInUp mb-2"
      ...
      <div
        class="xl:max-w-[1728px] w-full mx-auto relative bg-[#92BDF5] xl:rounded-bl-5xl xl:rounded-br-5xl py-12"
      >
        <div class="container">
          <div class="grid grid-cols-12 gap-x-6 gap-y-6">
            <div
    ...
    <section class="pb-[70px]">
      <div class="container">
        <h3
          class="text-center pb-10 wow animate__animated animate__fadeInUp"
          data-wow-delay="0.2s"
        >
          Shop By Brands
        </h3>
        <div class="grid grid-cols-12 gap-6">
          <div
            class="border border-[#919EAB3D] rounded-2xl py-6 px-[51px] mx-auto col-span-6 md:col-span-4 xl:col-span-2 lg:col-span-3 wow animate__animated animate__fadeInUp"
            data-wow-delay="0.2s"
          >
            <img src="assets/images/merck.png" alt="Merck" />
          </div>
          <div
            class="border border-[#919EAB3D] rounded-2xl py-6 px-[51px] mx-auto col-span-6 md:col-span-4 xl:col-span-2 lg:col-span-3 wow animate__animated animate__fadeInUp"
            data-wow-delay="0.3s"
          >
            <img src="assets/images/norton.png" alt="Norton" />
          </div>
          <div
            class="border border-[#919EAB3D] rounded-2xl py-6 px-[51px] mx-auto col-span-6 md:col-span-4 xl:col-span-2 lg:col-span-3 wow animate__animated animate__fadeInUp"
            data-wow-delay="0.4s"
          >
            <img src="assets/images/abbott.png" alt="Abbott" />
          </div>
          <div
            class="border border-[#919EAB3D] rounded-2xl py-6 px-[51px] mx-auto col-span-6 md:col-span-4 xl:col-span-2 lg:col-span-3 wow animate__animated animate__fadeInUp"
            data-wow-delay="0.5s"
          >
            <img src="assets/images/davita.png" alt="Davita" />
          </div>
          <div
            class="border border-[#919EAB3D] rounded-2xl py-6 px-[51px] mx-auto col-span-6 md:col-span-4 xl:col-span-2 lg:col-span-3 wow animate__animated animate__fadeInUp"
            data-wow-delay="0.6s"
    ...
    <section class="mb-[70px]">
      <div
        class="bg-[#A0E2E0] xl:max-w-[1728px] w-full mx-auto xl:rounded-tr-5xl relative flex flex-col gap-y-4 md:gap-y-0 md:flex-row items-center justify-between pt-12 lg:pt-0"
      >
        <div
          class="lg:bg-white bg-[#A0E2E0] pb-0 lg:pt-0 flex-none lg:w-full lg:pb-[23px] lg:pl-12 pl-4 md:text-left text-center max-w-xl lg:rounded-tr-[164px] relative z-5 lg:after:bg-[#A0E2E0] lg:before:absolute lg:before:top-full lg:before:left-0 lg:before:h-12 lg:before:w-12 lg:before:bg-[url('images/home-2/slider-left-shape-2.html')] lg:before:bg-no-repeat lg:before:z-11 lg:after:absolute lg:after:bottom-0 lg:after:right-0 lg:after:h-full lg:after:w-[145px] lg:after:bg-[url('images/slider-right-shape.html')] lg:after:bg-no-repeat lg:after:z-11"
        >
          <h3
            data-wow-delay=".2s"
            class="wow animate__animated animate__fadeInUp mb-2"
        ...
        >
          <div
            class="home-two-beauty-launched-product-nav md:flex items-center justify-center gap-x-6 hidden"
          ></div>
        </div>
      </div>

      <div
        class="xl:max-w-[1728px] w-full mx-auto relative bg-[#A0E2E0] xl:rounded-bl-5xl xl:rounded-br-5xl py-12"
      >
        <div class="container">
          <div class="home-two-beauty-launched-product-slider-wrapper">
            <div
              data-slick='{"slidesToShow": 5, "slidesToScroll": 1, "loop": true, "arrows": true, "infinite": true, "appendArrows": ".home-two-beauty-launched-product-nav", "autoplay": true, "autoplaySpeed": 7000, "responsive": [{"breakpoint": 1441, "settings": {"slidesToShow": 4}}, {"breakpoint": 1025, "settings": {"slidesToShow": 3}}, {"breakpoint": 769, "settings": {"slidesToShow": 2}}, {"breakpoint": 480, "settings": {"slidesToShow": 1}}]}'
              class="home-two-beauty-launched-product-slider -mx-3 sellzy-slider"
            >
              <!-- 1 -->
              <div
                class="bg-white rounded-2xl product-card-1 p-4 group mx-3 wow animate__animated animate__fadeInUp"
